...
<h1 align="center">Gald3r for Antigravity</h1>

<p align="center">
  The <strong>Antigravity edition</strong> of Gald3r -- file-based memory, task management, and
  agent orchestration that runs <strong>inside Antigravity</strong>. Part of the Gald3r framework
...
This is the **Antigravity distribution** of Gald3r. The [`antigravity/`](./antigravity/) folder is a
complete, ready-to-deploy gald3r setup tuned for Antigravity -- drop its contents into your
...
```bash
git clone https://github.com/wrm3/gald3r_platform_antigravity.git
cp -r gald3r_platform_antigravity/antigravity/. /path/to/your/project/
```

Then open the project in Antigravity and type `@g-status` to confirm gald3r loaded.

> The `antigravity/` payload is **additive** -- it drops in gald3r's config + `.gald3r/` state and
